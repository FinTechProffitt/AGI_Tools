...
class CodingTool(BaseTool):
    ...
    description = (
        ...
        "REMEMBER to include the imports and the libraries you will use."
        "Remember to exhaustively comment the code, including the full defintion of each function and class."
        "Remember to include functional code for each function and class within the code blocks, including any placeholders or pointers for variables."
